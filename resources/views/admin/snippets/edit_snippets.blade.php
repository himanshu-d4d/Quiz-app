      ...
      <div class="row">
        <div class="col-md-8" style = "margin-left:100px">
          <div class="card card-primary">
            ...
            <form action = "{{url('admin/update-snippets')}}" method="POST" enctype='multipart/form-data'>
            @csrf
            <div class="card-body">
              <div class="form-group">
                <label for="inputName">Snippets Number</label>
                <input type="hidden" name="id" value="{{$snippet->id}}">
                <input type="text" name ="snippets_no" class="form-control" value="{{$snippet->snippets_no}}">
